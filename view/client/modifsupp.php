...
<head>
    ...
    <title>Acceuil | ADMINISTRATEURS | MODIFIER/SUPPRIMER CLIENT</title>
</head>
<body>
    ...
    <div class="container">
        ...
        if (!empty($clients)) {
            ...
            foreach ($clients as $client) {
                ...
                echo '<button type="submit" class="supp">Supprimer</button>';
                echo '</form>';
                ...
                echo '<button type="submit" class="modif">Modifier</button>';
                echo '</form>';
                echo '</div>';
                echo '</td>';
                echo '</tr>';
